...
import com.github.slfotg.collection.BitSetList;
...
public final class Primes {
    ...
    protected static final Function<Integer, Integer> MAPPING = n -> {
    ...
    public static List<Integer> getPrimes(int max) {
        ...
        BitSetList<Integer> bitSetList = new BitSetList<>(bitSet, MAPPING);
        return new CompositeSequentialList<>(SMALL_PRIMES, bitSetList);
    }
